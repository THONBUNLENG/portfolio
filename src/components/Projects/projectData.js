...
export const projects = {
  project1: {
    ...
    descriptionZh: "一款高性能、可扩展且视觉精美的 Flutter 移动电商应用，专为在线杂货店业务设计。采用稳健的 Clean Architecture 方法和企业级状态管理构建。",
  ...
  project2: {
    ...
    descriptionZh: "一款为 Pontoon Club 设计的现代 Flutter 移动应用，为会员提供无缝体验，通过直观的界面访问俱乐部信息、活动和服务。",
  ...
  project3: {
    ...
    descriptionZh: "一款为 MJQ AIS 和 AII 学校设计的 Flutter 移动应用，为学生、家长和教师提供一个集中平台，以访问学术信息、管理学校活动并加强学校社区内的沟通。",
  ...
  project4: {
    ...
    descriptionZh: "BIU 大学移动应用旨在改善大学社区内的沟通和可访问性。该应用集中了重要的大学服务和信息，使用户能够随时随地保持知情和联系。",
  ...
  project5: {
    ...
    descriptionZh: "一款为 PIS 学校设计的 Flutter 移动应用，为学生、家长和教师提供一个集中平台，以访问学术信息、管理学校活动并加强学校社区内的沟通。",
  ...
  project6: {
    ...
    descriptionZh: "一款为 Beltei 国际学校设计的 Flutter 移动应用，为学生、家长和教师提供一个集中平台，以访问学术信息、管理学校活动并加强学校社区内的沟通。",
  ...
  project7: {
    ...
    descriptionZh: "一款优质跨平台电商移动应用，具有动态产品目录、无缝导航、交互式评分系统和个人愿望清单。",
    ...
    descriptionZh: "一个简洁且可复用的 Flutter 主题管理系统，使用 Flutter 的 ThemeData 支持浅色模式和深色模式。本项目演示如何为不同的 UI 组件创建和组织自定义主题，同时在应用程序中保持一致的设计。",
  ...
  project9: {
    ...
    descriptionZh: "一款使用 Laravel 和 Node.js 构建的现代 Web 应用，提供无缝的在线购物体验。它具有用户友好的界面、安全的支付处理以及为客户和管理员提供的产品管理功能。",
  ...
  project10: {
    ...
    descriptionZh: "一款使用 C# Windows Forms 和 SQL Server 开发的现代桌面应用，将咖啡店管理、用户统计和排行榜跟踪整合到一个平台中。",
  ...
  project11: {
    ...
    descriptionZh: "一个基于角色的管理仪表板，使用 Laravel 构建。它具有用户认证、角色管理和响应式界面，用于管理应用程序的各个方面。",
  ...
  project12: {
    ...
    descriptionZh: "一个基于 Python 的 AI 驱动 Selenium 自动化项目，利用机器学习算法来增强 Web 测试和交互。它利用 AI 技术智能导航网页、识别元素和执行自动化操作，提高 Web 测试流程的效率和准确性。",
    ...
    descriptionZh: "一个功能齐全的销售点（POS）应用，旨在管理交易、跟踪库存并生成实时销售报告。",
  ...
  project14: {
    ...
    descriptionZh: "一款使用 C# Windows Forms 和 SQL Server 开发的现代桌面应用，将教育贷款管理、用户统计和排行榜跟踪整合到一个平台中。",
