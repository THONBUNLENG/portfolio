...
export const projects = {
  project1: {
    ...
    titleKm: "កម្មវិធី E-commerce Pink House",
    ...
    descriptionKm: "កម្មវិធី Flutter ទូរស័ព្ទ e-commerce ដ៏មានប្រសិទ្ធភាពខ្ពស់ អាចពង្រីកបាន និងមើលទៅស្រស់ស្អាត ដែលរបស់ក្រុកហាងកាហ្វេបន្ដានអនឡ្ឋបវេស រ� builder ជាមួយវម្�ធាន់ Clean Architecture ហើយមានការគ្រប់គ្រង state កម្រិតអាជីវកម្ម។",
  ...
  project2: {
    ...
    titleKm: "កម្មវិធីសហគម្គ Pontoon",
    imgPath: club,
    ...
    descriptionKm: "កម្មវិធីទូរស័ព្ទ Flutter ទំនើប សម្រាប់សហគមន៍ Pontoon ផ្តល់ឱកាសអ្នកសម្ដេរចូលដំនើរព័ត៌មាន ព្រឹត្តិការណ៍ និងសេវាកម្មរុស្រសះយពីរក្នុងផ្ទាំងមួយ ។",
  ...
  project3: {
    ...
    titleKm: "កម្មវិធីសាលាអប់រំ MJQ AIS និង AII",
    imgPath: mjq,
    ...
    descriptionKm: "កម្មវិធីទូរស័ព្ទ Flutter សម្រាប់សាលាអប់រំ MJQ AIS និង AII ផ្តល់ឱកាសសិស្ស ឪពុកម្តាយ និងគ្រូសារសួស្តីជាមួយនិងក្ដោរកណ្ដាលដើម្បីចូលដំនើរព័ត៌មានសិក្សា គ្រប់គ្រងសកម្មភាព និងបង្កើតការទំនាក់ទំនងផ្ទាល់ខ្លួនក្នុងសហគមន៍សាលា។",
  ...
  project4: {
    ...
    titleKm: "កម្មវិធីសាកលវិទ្យាល័យ ប៊ែលធី",
    imgPath: biu,
    ...
    descriptionKm: "កម្មវិធីទូរស័ព្ទសាកលវិទ្យាល័យ ប៊ែលធី រិក្សាបន្ដភាពនៃការទំនាក់ទំនង និងទំនាក់ទំនងនៃការជ្រើសរើសជ្រើសរើសក្នុងសហគមន៍សាកលវិទ្យាល័យ។ កម្មវិធីនេះបានចូលផ្តូរសេវាកម្ម និងព័ត៌មានស្រដើរស្រស់ស្អាត ផ្តល់ឱកាសអ្នកប្រើប្រាស់ការទាយទាយ និងទាយទាយពេលណាមួយកន្លះ។",
  ...
  project5: {
    ...
    descriptionKm: "កម្មវិធីទូរស័ព្ទ Flutter សម្រាប់សាលាអប់រំ PIS ផ្តលះឱកាសសិស្ស ឪពុកម្តាយ និងគ្រូសារសួស្តីជាមួយនិងក្ដោរកណ្ដាលដើម្បីចូលដំនើរព័ត៌មានសិក្សា គ្រប់គ្រងសកម្មភាព និងបង្កើតការទំនាក់ទំនងផ្ទាល់ខ្លួនក្នុងសហគមន៍សាលា។",
    ghLink: "https://github.com/THONBUNLENG/pis_school.git",
    demoLink: "",
  },
  project6: {
    title: "School App",
    titleKm: "កម្មវិធីសាលាអប់រំ",
    imgPath: school,
    ...
    descriptionKm: "កម្មវិធីទូរស័ព្ទ Flutter សម្រាប់សាលាអន្តរជាតិ ប៊ែលធី ផ្តលះឱកាសសិស្ស ឪពុកម្តាយ និងគ្រូសារសួស្តីជាមួយនិងក្ដោរកណ្ដាលដើម្បីចូលដំនើរព័ត៌មានសិក្សា គ្រប់គ្រងសកម្មភាព និងបង្កើតការទំនាក់ទំនងផ្ទាល់ខ្លួនក្នុងសហគមន៍សាលា។",
    ghLink: "https://github.com/THONBUNLENG/-school_management.git",
    demoLink: "",
  },
  project7: {
    title: "System Loan",
    titleKm: "ប្រព័ន្ធឥណ្តងឥណ្តង",
    imgPath: loan,
    ...
    descriptionKm: "កម្មវិធីបង្កើតផ្ទាល់ខ្លួនដោយប្រើ C# Windows Forms និង SQL Server ដែលផ្សេងផ្ស់និងការគ្រប់គ្រង ឥណ្តងឥណ្តង ការវដ្ដសិទ្ធិអ្នកប្រើប្រាស់ និងការតាមដានឋheon ដូច្នក្នុងទីតាំងតែមួយ។",
    ghLink: "https://github.com/THONBUNLENG/loan_and_game.git",
    demoLink: "",
  },
  project8: {
    title: "System Coffee shop",
    titleKm: "ប្រព័ន្ធហាងកាហ្វេ",
    imgPath: pos_coffee,
    ...
    descriptionKm: "កម្មវិធីបង្កើតផ្ទាល់ខ្លួនដោយប្រើ C# Windows Forms និង SQL Server ដែលផ្សេងផ្ស់និងការគ្រប់គ្រង ហាងកាហ្វេ ការវដ្ដសិទ្ធិអ្នកប្រើប្រាស់ និងការតាមដានឋheon ដូច្នក្នុងទីតាំងតែមួយ។",
    ghLink: "https://github.com/THONBUNLENG/coffee-shop-system.git",
    demoLink: "",
  },
  project9: {
    title: "E-Commerce Web",
    titleKm: "វេបសាយអន្តរជាតិ",
    ...
    descriptionKm: "កម្មវិធីវេបសាយទំនើប បង្កើតផ្ទាល់ខ្លួនដោយប្រើ Laravel និង Node.js ដែលផ្តលះឱកាសអ្នកទិញទៅផ្ទាល់ខ្លួន មានផ្ទាំងរួមបញ្ចូល និងការគ្រប់គ្រងផលិតផលសម្រាប់អ្នកទិញ និងអ្នកគ្រប់គ្រង។",
    ghLink: "https://github.com/THONBUNLENG/ecommerce_api.git",
    demoLink: "",
  },
  project10: {
    title: "Admin Dashboard",
    titleKm: "ផ្ទាំងគ្រប់គ្រងជាអ្នកគ្រប់គ្រង",
    imgPath: admin,
    ...
    descriptionKm: "ផ្ទាំងគ្រប់គ្រងជាអ្នកគ្រប់គ្រង បង្កើតផ្ទាល់ខ្លួនដោយប្រើ Laravel ផ្តលះឱកាសការផ្ទៀងផ្ទាត់អ្នកប្រើប្រាស់ ការគ្រប់គ្រងតួនាដ និងផ្ទាំងរួមបញ្ចូលសម្រាប់គ្រប់គ្រងទូខ្សែសភាគរន្តា។",
