      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi everyone! I’m <span className="purple">THON BUNLENG</span>{" "}
            ...
            <span className="purple">BELTEI International University</span>.
            <br />
            <br />
          ...
          <footer className="blockquote-footer">THON BUNLENG</footer>
        </blockquote>
      </Card.Body>
    </Card>
  );
